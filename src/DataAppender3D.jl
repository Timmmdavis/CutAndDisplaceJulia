function DataAppender3D( PntsInput1,PntsInput2,TrisInput1,TrisInput2 )
...
function GetSizesAndAppendLists( PntsInput1,PntsInput2,TrisInput1,TrisInput2 )

#Number of original points that make the tris for Input 1
Sz=length(PntsInput1[:,1]);    
...
#Getting sizes
Sz1=length(TrisInput1[:,1]);
Sz2=length(TrisInput2[:,1]);

return AppendedPoints,AppendedTriangles,Sz1,Sz2
