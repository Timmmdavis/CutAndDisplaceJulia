function RotateCosine3D(InputCosine,Angle,RotationAxis)
...
if RotationAxis=="x"
        ...
        #[0,    cos(a), -sin(a) ]
        #[0,    sin(a), cos(a)  ]
    RotationMatrix[1,1,1:1:end] = ones(1,1,n);
...
elseif RotationAxis=="y"   
    ...
    RotationMatrix[2,2,1:1:end] = ones(1,1,n);
    ...
    RotationMatrix[2,2,1:1:end] = cos(Angle[1:1:end,:]);
    RotationMatrix[3,3,1:1:end] = ones(1,1,n);
end

for i=1:n #its 3 cols wide  
